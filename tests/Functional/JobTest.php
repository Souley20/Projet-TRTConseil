...
class JobTest extends WebTestCase
{
    public function testJob(): void
    {
        ...
        // Récup entity manager, il faut être connecté , 79=user recruteur
        ...
        $form = $crawler->filter("form[name=registration_form_type_job]")->form([
            ...
            'registration_form_type_job[workPlace]' => "Toulouse",
            'registration_form_type_job[description]' => "Serveur Resto Speed",
    ...
    public function testIfListJObIsSuccessfull(): void
    {
        ...
        // Récup entity manager, il faut être connecté , 18=admin
...

    {
        ...
        $crawler = $client->request(
            Request::METHOD_GET,
            $urlGenerator->generate('app_job_delete', [25])
        );     
